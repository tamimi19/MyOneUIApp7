...
// حالة الـ drawer عندنا لأن One UI DrawerLayout لا يوفر isDrawerOpen(boolean)
...
private void setupDrawer() {
    ...
    // Listener لمتابعة حالة الفتح/الإغلاق لأن مكتبة One UI لا تملك isDrawerOpen(boolean)
    mDrawerLayout.setDrawerListener(new DrawerLayout.DrawerListener() {
        @Override
        public void onDrawerSlide(View drawerView, float slideOffset) { /* اختياري */ }
        ...
        @Override
        public void onDrawerStateChanged(int newState) { /* اختياري */ }
    });
...
public void onBackPressed() {
    // استعملنا المتغيّر الذي نحدّثه عبر DrawerListener بدل isDrawerOpen(true)
    if (mIsDrawerOpen) {
        mDrawerLayout.setDrawerOpen(false, true);
